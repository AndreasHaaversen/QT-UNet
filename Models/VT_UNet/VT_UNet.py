...
from Models.utils import common_predict_step, get_metrics, log_gif, step_log

from .components import SwinTransformerSys3D


class VTUNet(LightningModule):
    def __init__(
        self,
        args,
        input_shape,
        ...
        **kwargs,
        ...
        exclusive_targets = (
            args.exclusive_targets if hasattr(args, "exclusive_targets") else False
        )
        include_background = (
            args.include_background if hasattr(args, "include_background") else True
        )
    ...
    def predict_step(self, batch, batch_idx: int, dataloader_idx: int = 0):
        return common_predict_step(
            batch, self.roi_size, self.swin_unet, self.post_trans
        )
